        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-gmax-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Phones & Tablets</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Office Equipment</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Home Appliances</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Networking Gadgets</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                <Mail className="h-5 w-5 mr-3 text-gmax-accent" />
                <span className="text-gray-300">info@gmaxtechnologies.com</span>
              </li>
              <li className="flex items-start">
